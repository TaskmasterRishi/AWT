...
if (isset($_POST["message"])) {
    ...
    try {
        ...
        // Recipients
        $mail->setFrom('kimjisooishart@gmail.com', 'BVM Engineering College');
        $mail->addAddress($_POST["email"]);
        $mail->addReplyTo('kimjisooishart@gmail.com', 'BVM Engineering College');
        ...
        $mail->Body = "
            ...
            <p>Once again, thank you for choosing BVM Engineering College.. We look forward to assisting you and appreciate your continued support.</p>
            <p>Best regards,</p>
            <p>Lorem Ipsum</p>
        ";
