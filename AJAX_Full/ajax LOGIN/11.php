        ...
        function checkForm() {
            ...
            if (name == '' || password == '' || email == '' || mob == '') {
                ...
                if (username1 == 'Username is already registred' || password1 == 'Password too short' || email1 == 'Invalid email' || mob1 == 'Invalid mob' || email1 == "Email is already registred" || mob1 == 'mobile is already registred') {
                    ...
                    xmlhttp.open("GET", "insert.php?name1=" + name + "&email1=" + email + "&password1=" + password + "&contact1=" + mob, false);
                    xmlhttp.send();
                }
        ...
        <div class="innerdiv">
            ...
            <form action='#' id="myForm" method='post' name="myForm">
                ...
                <table>
                    <tr>
                        <td>Username</td>
                        <td><input id='username1' name='username1' onblur="validate('username', this.value)"
                                type='text'></td>
                        <td>
                            <div id='username'></div>
                        </td>
                    ...
                    <tr>
                        <td>Password</td>
                        <td><input id='password1' name='password1' onblur="validate('password', this.value)"
                                type='password'></td>
                        <td>
                            <div id='password'></div>
                        </td>
